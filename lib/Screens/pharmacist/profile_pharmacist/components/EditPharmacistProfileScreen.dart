...
class EditPharmacistProfileScreen extends StatefulWidget {
  final String defaultName;
  final String defaultEmail;
  final String defaultPhone;

  const EditPharmacistProfileScreen({
    Key? key,
  ...
  @override
  _EditPharmacistProfileScreenState createState() => _EditPharmacistProfileScreenState();
}

class _EditPharmacistProfileScreenState extends State<EditPharmacistProfileScreen> {
