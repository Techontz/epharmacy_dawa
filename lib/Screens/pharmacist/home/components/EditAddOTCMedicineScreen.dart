...
class EditAddOTCMedicineScreen extends StatefulWidget {
  @override
  _EditAddOTCMedicineScreenState createState() =>
      _EditAddOTCMedicineScreenState();
}

class _EditAddOTCMedicineScreenState extends State<EditAddOTCMedicineScreen> {
  List<File> _images = [];
